  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="shrink-0 rounded-md p-1 text-zinc-600 opacity-0 transition hover:bg-white/5 hover:text-zinc-300 focus-visible:opacity-100 group-hover:opacity-100"
      >
