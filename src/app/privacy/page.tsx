...
const sections: LegalSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "CardFlip runs on Fly.io infrastructure in the United States, and your data is stored there. By using CardFlip you consent to your data being processed in the United States.",
  ...
  },
  {
    ...
    paragraphs: [
      "Service providers only, and only what they need to do their job: hosting (Fly.io) and AI card reading (Anthropic), as described above. When eBay listing integration is connected, listing content will go to eBay under your own eBay account — at your explicit direction each time.",
