...
- [ ] ON-DEVICE (Chris's iPhone): live camera + capture, torch/HUD positions, keyboard over the help composer, sheet scroll lock, real publish. The only mobile item left.
