...
- [x] 09-09 Admin console is sub-pages (/admin, /switches, /board, /users, /cards, /data, /errors, /system) — Chris yea (09-09). Board is live in the admin console (DB-backed, editable) · e2e runs on Android Chrome (Pixel 7) AND WebKit/iPhone 13 every push.
